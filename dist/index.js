...
var _isBrowser = isBrowser;

var _excluded = ["noWrapper", "ssrOnly", "whenIdle", "whenVisible", "promise", "on", "children", "didHydrate", "as"];
// React currently throws a warning when using useLayoutEffect on the server.
var useIsomorphicLayoutEffect = _isBrowser ? React__namespace.useLayoutEffect : React__namespace.useEffect;
...
function LazyHydrate(props) {
  ...
  var _React$useReducer = React__namespace.useReducer(reducer, !(_isBrowser)),
